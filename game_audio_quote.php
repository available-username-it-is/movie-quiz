<?php
    ...
    $question = "Guess the movie by quote?";
    ...
    $quote = makeAnswers($connection, "movies", "audio_quote");
    if (in_array($quote[4], $_SESSION["past_soundtracks"])) {
        while (in_array($quote[4], $_SESSION["past_quotes"])) {
            $quote = makeAnswers($connection, "movies", "quote");
        }
    }
    array_push($_SESSION["past_soundtracks"], $quote[4]);
    $score = 0;
        ...
        <section>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <div class="question-visual"><?php 
                        ...
                        echo "
                        <audio autoplay>
                            <source src='" . $quote[4] . "' type='audio/mp3'>
                        </audio>
                    ";
                ?></div>
                ...
                <input type="hidden" id="secret" value="<?php echo $quote[5]; ?>">
            </form>  
        </section>
    </main>
